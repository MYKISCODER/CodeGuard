"""
Generate main comparison table for SemiReal-20: CodeGuard vs Baselines
...
def main():
    ...
    # Load results
    codeguard = load_results(RESULTS_DIR / "sr20v2_e2e_v4_strict_exempt.csv")
    llm_judge = load_results(RESULTS_DIR / "semireal20_baseline_llm_judge.csv")
    sast = load_results(RESULTS_DIR / "semireal20_baseline_sast.csv")

    # Generate comparison table
    out_path = OUTPUTS_DIR / "semireal20_main_table.csv"
    ...
    print()
    print("=" * 80)
    print("SEMIREAL-20 MAIN COMPARISON TABLE")
    print("=" * 80)
