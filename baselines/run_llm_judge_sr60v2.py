"""
CodeGuard Baseline — LLM Judge on SemiReal-60 v2

Runs LLM Judge baseline specifically on SemiReal-60 v2 benchmark.
"""
...
def run():
    ...
    print(f"LLM Judge Baseline on SemiReal-60 v2")
    ...
    # Write CSV
    out_path = RESULTS_DIR / "sr60v2_baseline_llm_judge.csv"
