"""
CodeGuard Baseline — LLM Judge on SemiReal-20

Runs LLM Judge baseline specifically on SemiReal-20 v2 benchmark.
"""
...
def run():
    ...
    print(f"LLM Judge Baseline on SemiReal-20 v2")
    ...
    # Write CSV
    out_path = RESULTS_DIR / "semireal20_baseline_llm_judge.csv"
