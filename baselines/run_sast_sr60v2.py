"""
CodeGuard Baseline — SAST Scan on SemiReal-60 v2

Pure regex/string-based static analysis on SemiReal-60 v2 benchmark.
"""
...
def run():
    print(f"SAST Baseline on SemiReal-60 v2\n")
    ...
    # Write CSV
    out_path = RESULTS_DIR / "sr60v2_baseline_sast.csv"
