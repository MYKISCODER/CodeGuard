"""
CodeGuard — Gold Baseline for SemiReal-20 v2 benchmark
"""
...
def run():
    ...
    for mode in MODES:
        csv_path = OUTPUT_DIR / f"sr20v2_gold_{mode.lower().replace('-','_')}.csv"
    ...
    # Summary
    print("\n" + "=" * 80)
    print("SEMIREAL-20 v2 GOLD BASELINE SUMMARY")
    print("=" * 80)
    for mode in MODES:
        csv_path = OUTPUT_DIR / f"sr20v2_gold_{mode.lower().replace('-','_')}.csv"
