"""
SemiReal-120 v1 E2E Runner with CodeGuard v4.1

Extends SR60v2 to SR120v1 to validate result consistency.
"""
...
MODES = ["STRICT-EXEMPT"]  # Only run main mode for speed

# Use v4.1 prompt (same as SR60v2)
LAYER2_PROMPT_V4_1 = """\
...
def run():
    ...
    print(f"Using CodeGuard v4.1 (STRICT-EXEMPT mode)\n")
    ...
    for i, case in enumerate(cases):
        cid = case["case_id"]
        print(f"  [{i+1}/{len(cases)}] Layer2 v4.1: {cid} ...")
    ...
    # Save raw
    raw_path = OUTPUT_DIR / "sr120v1_layer2_v4_1_raw.json"
    ...
    print(f"\nRaw Layer2 v4.1 outputs saved to {raw_path}")

    # Policy for STRICT-EXEMPT mode
    mode = "STRICT-EXEMPT"
    csv_path = OUTPUT_DIR / f"sr120v1_e2e_v4_1_strict_exempt.csv"
    ...
    # Summary
    print("\n" + "=" * 80)
    print("SEMIREAL-120 v1 E2E SUMMARY (CodeGuard v4.1)")
    print("=" * 80)
